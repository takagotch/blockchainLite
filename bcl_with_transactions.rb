...
b0 = Block.first(
              { from: "Dutchgrown", to"Vicent", what: "Tulip Booemendaal", qty: 10 },
              { from: "Keukenhof", to: "Anne", what: "Tuip Semper Augustus", qty: 7 } )

b1 = Block.next(b0,
              { from: "Flowers", to: "Ruben", what: "Tulip Admiral van Eijck", qty: 5 },
              { from: "Vicent", to: "Anne", what: "Tulip Bloemendaal Sunset", qty: 3 },
              { from: "Anne", to: "Julia", what: "Tulip Semper Augusts", qty: 1 },
              { from: "Julia", to: "Luuk", what: "Tulip Semper Augustus", qty: 1 } )

b2 = Block.next(b1,
              { from: "Bloom & Blossom", to: "Daisy", what: "Tulip Admiral of Admirals", qty: 8 },
              { from: "Vicent", to: "Max", what: "Tulip Bloomendaal Sunset", qty: 2 },
              { from: "Anne", to: "Martijn", what: "Tulip Semper Augustus", qty: 2 },
              { from: "Ruben", to: "Julia", what: "Tuip Admiral van Eijck", qty: 2 } )

b3 = Block.next( b2,
              { from: "Teleflora", to: "Max", what: "Tulip Red Impression", qty: 8},
              { from: "Anne", to: "Naomi", what: "Tulip Blooemendaal Sunset", qty: 2},
              { from: "Daisy", to: "Vicent", what: "Tulip Admiral of Admirals", qty: 2},
              { from: "Ruben", to: "Mina", what: "Tulip Admiral van Eijck", qty: 2} )
